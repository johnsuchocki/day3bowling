...
//coded together by Michael Donnelly, Keith Gibson, & John Suchocki

public class LetsGoBowling {
	...
	public static void main(String[] args) {
	    ...
	    //scores all throws into a frame array
		...
		//sums frame array to a score variable, then sends it to print
